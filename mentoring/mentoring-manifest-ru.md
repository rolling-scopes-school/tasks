...
#### AI и честность
Студенты могут использовать AI для обучения: смотреть объяснения, разбирать код, спрашивать "почему так работает".
Но задания курса они обязаны выполнять самостоятельно:

• писать код руками
• понимать каждую строчку
• уметь объяснить решение на интервью

Если студент почти ни на что не отвечает - таких отчисляем.
Менторы не ставят минимальный балл «из жалости».

#### NotebookLM и конвертация стримов в материалы
* Саша рассказал эксперимент: он загрузил свой старый трёхчасовой стрим в **NotebookLM** и получил несколько аккуратных конспектов с разными акцентами (на паттерны, подход, архитектуру). Пример: https://t.me/c/1442979966/45272 
...
### Материалы
Презентация: https://mikaleinik.github.io/rs-webinar/mentorship/
Короткое видео: https://www.youtube.com/watch?v=p_k0V7zh1Lk&list=PLzLiprpVuH8fE1hhU_5GLLwsNzRBSY3Uf
Полная документация: https://rs.school/docs/ru/mentoring-first-interview
