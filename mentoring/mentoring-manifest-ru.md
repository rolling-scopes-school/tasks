### Вступление
Этот текст появился в результате разговоров с менторами RS School — как новичками, так и с теми, кто менторил уже пять и более наборов студентов. Цель разговоров — понять, что именно им нравится в RS School, собрать лучшие практики и сформировать общее представление о том, что означает термин «ментор» в контексте RS School.
Ведь ментор может быть и "экзаменатором", и "коучем", и "другом". А может быть "студентом", который сам учится — но не TS/FE-разработке, а именно менторству и проведению лекций.
В таком формате весь процесс воспринимается как честный договор, в котором у всех есть свои бенефиты. Студенты понимают, что ментор тоже пришёл учиться, и что ему можно и нужно дать честный фидбек. В итоге все участники комьюнити растут вместе — и менторы, и студенты. А позже уже и сами студенты могут вернуться в RS School уже в роли менторов.
...
### Общие проблемы
* Требования к **джунам**, **мидлам** и т.д. постоянно растут.
...
* Возможность для студента оставить фидбэк по ментору — анонимный или публичный. +1 +1
...
* Попробовать себя в новой роли, научиться/набить руку на код ревью, закрыть собственные пробелы, получить доступ в классное комьюнити
...
* На созвонах ментор должен спросить - а как бы студент изменил ту или иную функциональность задания и какие правки для этого ему необходимо сделать. Цель - проверить понимание студентом кода и его умения без LLM решать технические проблемы. Другие вопросы вида - "Почему ты использовал этот принцип/подход/whatever здесь?", "Почему может быть плохо инициализировать сервис внутри другого сервиса напрямую? Что ты знаешь о DI? также крайне приветсвуются.
* Мы ожидаем, что ментор готов выделять как **минимум два часа времени раз в две недели** на общий созвон со своими студентами. В идеале во время таких созвонов - читать лекции или лайвкодить вместе, можно с AI, разбирать какую-то тему.
...
### Идеи
1.  В EPAM есть годные курсы внутренние, которые на внешнюю аудиторию бы зашли. Например, SA School. Мб, запустить что-то про архитектуру фундаментальную, про *систем-дизайн*. +1 +1
...
3.  Live coding вебинары по использованию AI.
