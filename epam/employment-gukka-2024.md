...
1. **Pass TechCheck assessment or Technical Interview on TypeScript with a good result.**
   - **Resources:**
...
2. **Pass TechCheck assessment or Technical Interview on Framework (React or Angular) with good results.**
...
3. **Pass Live Coding Technical Interview on "Algorithms and Data Structures"**
...
5. **Record Self-Introduction Video**
   ...
   - **Guidelines & Tasks:** Self-introduction
...
3. EPAM JS XStack Lab Colibitation phase. A set of interviews with help us estimate you skills and fit to project positions. Depending on the results of the interviews and the availability of positions, we can transfer you to an EPAM's "Junior Software Engineer" position and start paying you a salary. More details can be found on the JS XStack Lab section.
...
On the page below you will find a description of the interview scores from the interview feedback: https://kb.epam.com/display/TI/Effective+feedback+guidelines
