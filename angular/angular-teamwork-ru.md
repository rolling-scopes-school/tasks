...
- [ ] Ритуал ежедневного 1-строчного сигнала в чате («сегодня делаю X, блокеров нет / есть Y»). Не для отчётности, а чтобы команда видела, кто жив.
- [ ] Канал в Discord/Telegram: один общий, без личек по проектным темам. Личка — для «давай созвонимся», не для архитектурных решений.

### Решения и архитектура

- [ ] Стек выбран и зафиксирован в README или ADR. Если выбор был спорным — отдельный ADR с причинами.
...
| «Спросим обоих менторов, как лучше» | Двое менторов с разными вкусами = смена стека дважды за неделю | Один ментор на команду; если несколько — синк менторов до созвона с командой |
