...
2. The student creates and submits a Pull Request before the deadline.
   - The PR rules are specified [below](https://rs.school/ru/docs/pull-request-review-process#описание-pull-request-должно-содержать-следующую-информацию)
   - Penalties for deadline violations are listed [below](https://rs.school/ru/docs/pull-request-review-process#дедлайны-для-студентов)
...
- [Pull Request Requirements](https://rs.school/ru/docs/pull-request-review-process#описание-pull-request-должно-содержать-следующую-информацию)
