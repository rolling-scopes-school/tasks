...
Run app and check that the functionality is working (cross-check). You can check details [here](https://rs.school/docs/cross-check-flow)

## Mentor's review process

A mentor check task must be submitted to the Mentor's review block in the Dashboard section of the RS App before the deadline. You can check details [here](https://rs.school/docs/mentoring/pull-request-review-process)
