...
- [Исходные данные](https://github.com/irinainina/image-data)  
  Репозиторий с исходными данными необходимо форкнуть или клонировать себе на компьютер. Редактировать его содержимое, чтобы улучшить качество созданного приложения, вы можете по своему усмотрению.
...
- всего на основании предложенных исходных данных можно сгенерировать 240 вопросов: 120 про художников, 120 про картины
...
- для каждой сыгранной категории можно открыть страницу с результатами, на которой можно посмотреть результат по каждому вопросу: был ли вопрос угадан в ходе викторины, правильный ответ на него
- сыгранный раунд можно пройти повторно, при этом вопросы будут повторяться, а варианты ответов будут другими
- в дизайн, оформление и функционал викторины можно вносить изменения, при условии, если они направлены на улучшение внешнего вида, функционала, удобства использования приложения, и не приводят к упрощению описанного в задании функционала и/или ухудшению внешнего вида приложения
...
- при вёрстке и оформлении приложения ориентируйтесь на [приложения-прототипы](https://github.com/rolling-scopes-school/tasks/blob/master/tasks/art-quiz/art-quiz.md#приложения-прототипы), созданные профессиональными разработчиками
...
- по высоте страницы приложения вписываются в экран десктопа, высота приложения не превышает 1024рх, исключением могут быть страницы категорий
...
- читабельность текста: минимальный размер шрифта на любом разрешении экрана не меньше 14рх, достаточная контрастность цвета фона и цвета шрифта в активном и неактивном состоянии, проверить контрастность на соответствие стандартам можно [здесь](https://www.bl2.ru/programing/colourcontrastcheck.html) 
...
- [Макет в figma](https://www.figma.com/file/vQ5Wm4ZSRcIYt1MQq8g8qD/ArtQuiz)  
  Макет предложен для ознакомления, в части пунктов он не соответствует требованиям задания и не является руководством для его выполнения или проверки.  
