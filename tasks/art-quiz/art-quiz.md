...
- [Макет в figma](https://www.figma.com/file/vQ5Wm4ZSRcIYt1MQq8g8qD/ArtQuiz)  
  *Макет даёт общее представление как может выглядеть приложение, вёрстка по макету не требуется, улучшения приветствуются.*  
...
- вёрстка адаптивная. Минимальная ширина страницы, при которой проверяется корректность отображения приложения - 360рх
- по высоте страницы приложения вписываются в экран десктопа: ни на одном разрешении высота приложения не превышает 1024рх, исключением могут быть страницы категорий
