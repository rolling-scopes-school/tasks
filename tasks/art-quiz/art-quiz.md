...
1. Стартовая страница и навигация +20
   - на стартовой странице есть кнопки, при клике по которым можно выбрать тип вопроса:
   ...
   - реализована навигация по страницам приложения +10
      ...
      - со страницы категорий при клике по карточке категории пользователь попадает на страницу с вопросами категории, при клике по результатам прохождения категории пользователь попадает  на страницу с результатами ответов на вопросы категории. Со страницы с вопросами и со страницы с результатами пользователь может вернуться на страницу категорий

   <kbd>![screenshot](assets/art-quiz-2.png)</kbd>

3. Страница категорий +50
   - всего в викторине не меньше 100 иллюстрированных вопросов +10  
   На основе предложенных исходных данных можно сгенерировать 200 вопросов: 100 про художников, 100 про картины
   - вопросы разбиты на группы (категории). В каждой категории 10 вопросов +10  
   Прохождение всех вопросов одной категории составляет один раунд игры.  
   Данные про проигранные раунды и их результаты хранятся в local storage.  
   - на странице категорий размещаются карточки категорий +10
   Категории категорий могут иметь названия, или их можно просто пронумеровать
   ...
   - карточка категории, на вопросы которой уже давались ответы, содержит результаты прохождения раунда: отношение количества вопросов, на которые был дан правильный ответ, к общему количеству вопросов +10  
...
4. Страница с вопросами +50
   - ни в коем случае не ожидается, что вы вручную напишете все вопросы викторины и варианты ответов к ним - вопросы не менее чем двух типов должны генерироваться автоматически на основе предложенных или созданных самостоятельно исходных данных +10  
...
5. Страница с результатами +50
   ...
   - есть кнопка сброса результатов проигрывания раунда +10
...
Примеры анимаций можно увидеть в [видео](https://youtu.be/0C9CjjuCOvM) и [gif](assets/art-quiz.gif)
   - 10 баллов за каждую уникальную сложную анимацию, улучшающую интерфейс и удобство использования приложения, но не больше 30 баллов.
...
7. Дополнительный функционал +20  
   - звуковая индикация правильных и неправильных ответов, звуковое сопровождение окончания раунда +10
   - есть переключатель, который позволяет выбрать игру на время или игру без учёта времени. Если выбрана игра на время, на странице с вопросами викторины отображается таймер, отсчитывающий время, которое отведено для ответа на вопрос, например, 20 секунд. Когда время истекает, это засчитывается как неправильный ответ на вопрос
