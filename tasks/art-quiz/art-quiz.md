...
- вы можете вносить изменения в дизайн, оформление и даже функционал викторины, при условии, что изменения позволяют улучшить внешний вид, возможности, удобство использования приложения, и не приводят к упрощению описанного в задании функционала и/или ухудшению внешнего вида приложения
- количество раундов викторины не меньше 10. В каждом раунде 10 вопросов с несколькими вариантами ответов. Пользователь выбирает ответ кликая по карточке с ним. После выбора пользователем ответа, появляется индикатор, разный для правильных и неправильных ответов, выводится правильный ответ. появляется возможность перейти к следующему вопросу. После окончания раунда выводится его результат - отношение вопросов, на которые был дан правильный ответ, к общему количеству вопросов. Результаты всех пройденных раундов отображаются на странице категорий. Также можно посмотреть результат по каждому сыгранному вопросу викторины, правильный ответ на него.
...
2. Страница настроек +30
   ...
   - если выбрана игра на время, на странице с вопросами викторины отображается таймер, который отсчитывает время, которое отведено для ответа на вопрос, например, 20 секунд +5
   - если выбрана игра на время, на протяжении одного раунда (10 вопросов) можно дважды поставить таймер на паузу. Есть счётчик, который показывает сколько раз ещё можно сделать паузу в текущем раунде +10

   <kbd>![screenshot](assets/art-quiz-7.png)</kbd>

3. Страница категорий +30
   - всего в викторине не меньше 100 вопросов +10  
   ...
   - вопросы разбиты на группы (категории) по 10 вопросов в каждой. Прохождение 10 вопросов одной категории составляют один раунд игры. Данные про проигранные раунды и их результаты хранятся в local storage. Категории могут иметь названия, или можно их просто пронумеровать +10
...
4. Страница с вопросами +50
   ...
   Например, на основании предложенных в задании исходных данных можно сгенерировать вопросы как про художников, так и про картины:

   <kbd>![screenshot](assets/art-quiz-4.png)</kbd>

   - вопросы в викторине идут в том порядке, в каком информация про картины и их авторов размещается в файле `images.js` коллекции исходных данных. Варианты ответов к вопросам генерируются случайным образом +10
   ...
   - после окончания раунда выводится модальное окно с поздравлением и результатами раунда - отношением количества вопросов, на которые был дан правильный ответ, к общему количеству вопросов +10
