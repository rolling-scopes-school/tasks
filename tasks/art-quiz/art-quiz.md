...
- Всего в викторине не меньше ста вопросов, которые разбиты на группы (категории). В каждой категории десять вопросов.    
На основе предложенных исходных данных можно сгенерировать двести вопросов: сто про художников, сто про картины.  
...
1. Стартовая страница и навигация +20
   ...
   На стартовой странице есть две кнопки, при клике по которым можно выбрать тип вопроса:
...
3. Страница с вопросами +60
   - вёрстка, дизайн, UI страницы с вопросами. Выполняются требования к вёрстке и оформлению приложения +10
   - ни в коем случае не ожидается, что вы вручную напишете все вопросы викторины и варианты ответов к ним - вопросы про художников и про картины должны генерироваться автоматически на основе предложенных или созданных самостоятельно исходных данных +10  
   ...
   Варианты ответов должны быть разными, в вариантах ответов не должны повторяться картины одного и того же художника.  
...
5. Реализована анимация отдельных деталей интерфейса, также анимированы переходы и взаимодействия, чтобы работа с приложением шла плавным и непрерывным потоком +30  
...
6. Дополнительный функционал +20  
