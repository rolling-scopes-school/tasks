...
1. Стартовая страница и навигация +20
   ...
   На стартовой странице есть кнопка, при клике по которой открывается модальное окно с настройками, и две кнопки, при клике по которым можно выбрать тип вопроса:
...
2. Настройки +30  
   В настройках есть возможность включать/выключать звук и включать/выключать игру на время
   - звуковая индикация правильных и неправильных ответов, звуковое сопровождение окончания раунда +10
   - если выбрана игра на время, на странице с вопросами викторины отображается таймер, отсчитывающий время, которое отведено для ответа на вопрос, например, 20 секунд +10
...
4. Страница с вопросами +50
   ...
   Ни в коем случае не ожидается, что вы вручную напишете все вопросы викторины и варианты ответов к ним - вопросы про художников и про картины должны генерироваться автоматически на основе исходных данных.  
