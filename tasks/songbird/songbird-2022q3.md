...
> \* Страницы с точки зрения того, какими их видит пользователь, их техническая реализация остаётся на ваше усмотрение (возможно реализация с использованием нескольких html файлов и SPA - способ реализации ни как не влияет на оценку)
