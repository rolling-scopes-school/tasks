...
- **Минимум для защиты:** Auth + Dashboard + 1 способ практики
- **Остальное — по возможности**

---

## Основной "идеальный" сценарий
...
**Минимум 4 страницы:** Landing, Dashboard, Practice, Profile

> **Примечание:** История сессий — часть Dashboard, а не отдельная страница.
