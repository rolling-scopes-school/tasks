...
- есть возможность перелистывания слайдов влево и вправо кликами по стрелкам. Слайды перелистываются по одному, при этом также меняется основное видео +4
...
- управление плеером с клавиатуры. Горячие клавиши должны работать так же, как работают эти клавиши в YouTube видео +10
   ...
   4) Клавиши `SHIFT`+`<` и `SHIFT`+`,` (англ) — ускорение воспроизведения ролика.  +2
   5) Клавиши `SHIFT`+`>` и `SHIFT`+`.` (англ) — замедление воспроизведения ролика +2
...
- при попытке ввода в форму невалидного значения выводится предупреждение, например, "номер телефона может содержать только цифры" +4

9. Интерактивная карта в секции `Contacts` +12
- в секции `Contacts` добавлена интерактивная карта +4
- на карте отображаются маркеры +4
- стиль карты такой как на макете +4

10. Любой собственный дополнительный функционал, улучшающий качество проекта. Например, ночная тема, плавная смена изображений в блоке `Tickets`, всплывающее окно с информацией про картины и их авторов, возможность проголосовать за понравившиеся картины с сохранением данных в locale storage, всё зависит от вашей фантазии и чувства вкуса. Для удобства проверки выполненный вами дополнительный функционал выведите в консоль браузера  +10
