...
3. Кастомный видеоплеер в секции `Video` +36
...
- на карте отображаются маркеры, расположение маркеров соответствует макету +4
- стиль карты и маркеров соответствует макету (если используется аналог mapbox, то стиль карты и маркеров должен быть визуально похож, но точное совпадение и проверка PerfectPixel не требуется) +4
