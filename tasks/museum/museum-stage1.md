...
Задание Museum - расширенная версия одноимённого задания, которое выдавалось на подготовительном этапе. В ходе его выполнения вам необходимо создать landing page Лувра – одного из крупнейших и наиболее популярных художественных музеев мира.

Если вы уже начали работу над заданием на этапе stage#0 или в ходе самостоятельной подготовки к курсу, продолжаете её, иначе выполняете задание с самого начала.
...
4. Форма покупки билетов +20
  ...
  - в форме присутствуют теги: `form`, `input type="date"`, `input type="time"`, `input type="text"`, `input type="email"`, `input type="tel"`, `input type="number"`, `select` +8 
  - вёрстка формы соответствует макету + 10
5. Требования к css + 16
...
6. Интерактивность, реализуемая через css +30
   - плавная прокрутка по якорям +5
   - параллакс +5
   - при кликам по кнопке `Discover the Louvre` и карточкам секции `Visiting` открываются полноэкранные панорамы Google Street View встроенные в страницы вашего сайта при помощи iframe +10
