...
Задание Museum - задание, в ходе выполнения которого вам необходимо сверстать landing page Лувра, добавить ему адаптивность и реализуемый через JavaScript функционал. В рамках первого этапа работы вам необходимо выполнить фиксированную верстку сайта по макету 1920px.

## Этапы работы над проектом:

- [фиксированная вёрстка](#фиксированная-вёрстка-ключевые-навыки) - 1 неделя
...
**Максимальный балл за задание – 130 баллов**
