...
8. использование js-библиотек разрешается только для создания слайдера и интерактивной карты. jQuery может подключаться только если она необходима для обеспечения работы js-библиотек
