...
6. Реализован адаптив YouTube-видео в слайдере в блоке `Video` на разрешениях 1440px-320px. При изменении ширины страницы плавно изменяется ширина YouTube-видео в плейлисте, маленькие видео выровнены по краям большого +5
