...
[Макет Museum – редактируется и дорабатывается](https://www.figma.com/file/IYLRvO74crJz2vMH20mO1S/Museum---stage1)
...
1. Вёрстка соответствует макету. Ширина экрана 1024px +50
- Блок `header` +5
- Секция `Welcome` +5
- Секция `Visiting` +5
- Секция `Explore` +5
...
- Секция `Gallery` +5
- Секция `Tickets` +5
- Форма покупки билетов +5
- Секция `Contacts` +5
- Блок `footer` +5
2. Вёрстка соответствует макету. Ширина экрана 768px +50
- Блок `header` +5
- Секция `Welcome` +5
- Секция `Visiting` +5
- Секция `Explore` +5
...
5. На ширине экрана 1024рх и меньше реализовано адаптивное меню +10 
   ...
   - вёрстка меню соответствует макету на всех проверяемых разрешениях +5 
6. Реализован адаптив YouTube-видео в слайдере в блоке `Video` на разрешениях 1440px-320px. При изменении ширины страницы плавно изменяется ширина YouTube-видео в плейлисте, маленькие видео выровнены по краям большого +10
