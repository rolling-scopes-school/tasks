...
5. На ширине экрана 1024рх и меньше реализовано адаптивное меню +12 
...
6. Реализован адаптив YouTube-видео в слайдере блока `Video` на разрешениях 1440px-320px. При изменении ширины страницы плавно изменяется ширина YouTube-видео в плейлисте, маленькие видео выровнены по краям большого +8
