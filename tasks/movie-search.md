...
### Basic scope +30  
- [ ] вёрстка, дизайн, UI. Адаптивность на ваше усмотрение +10
- [ ] поиск +10
...
- [ ] на карточке с фильмом указывается рейтинг IMDb +5
- [ ] название фильма является ссылкой на видеогаллерею даного фильма на сайте `https://www.imdb.com` +5
- [ ] бесконечный слайдер/свайпер +20
  - [ ] карточки с фильмами можно перелистывать как кликами по стрелкам, так и движениями мышки, слайдер/свайпер бесконечный +10
...
### Hacker scope +20
- [ ] поисковый запрос можно набирать на виртуальной клавиатуре и вводить кликая мышкой по кнопке Enter на ней +20*
