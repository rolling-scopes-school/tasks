...
- возможна проблема со сторонним свайпером, когда при переходе в режим эмуляции мобильного устройства в Chrome Dev Tools не работают свайпы. В данном случае необходимо, не закрывая Dev Tools, обновить страницу и попробовать сделать свайпы по контейрену с карточками
