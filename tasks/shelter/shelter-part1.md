...
Вам необходимо сверстать страницы `main` и `pets` согласно [макету](https://www.figma.com/file/tKcmzkARtMUFQAR9VLdLkl/shelter-dom) - **только main-1280** и **our-pets-1280**  
...
1. На страницу `Main` ведут:
  - элемент меню `About the shelter`
  - логотип в хедере
...
- если разрешение экрана 1280рх и больше, для проверки вёрстки на соответствие макету достаточно центрировать макет или вручную выставить макет по верхнему левому углу направляющих
- если разрешение экрана меньше 1280рх, для проверки используем device toolbar браузера Google Chrome в режиме responsive
