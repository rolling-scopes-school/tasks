...
3. Требования к css **+6**
   ...
   - при уменьшении масштаба(!Внимание: не ширины страницы) страницы браузера или увеличении ширины страницы (>1280px) вёрстка размещается по центру, а не сдвигается в сторону и не растягивается по всей ширине. При уменьшении ширины страницы (меньше 1280px) вёрстка может сдвигаться в сторону. **+2**
