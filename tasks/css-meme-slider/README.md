...
|------------------------| ------------- | --------- |
| 21.09.2024 00:00 (UTC) | cssMemeSlider | gh-pages  |
...
1. Слайдер должен быть реализован только с помощью CSS ;
2. Слайдер позиционируется с равными отступами слева и справа;
3. Расположение картинок, подписей к ним и контролов:
...
1. Выполнено всё из секции `Требования к репозиторию и как сабмитить задание` **+30**:
   - создана ветка `gh-pages` **+2**
   - создана папка `cssMemeSlider` **+2**
   ...
   - Описание Pull Request согласно ТЗ  **+5**
