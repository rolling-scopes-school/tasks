...
5.  [Названия коммитов должны быть согласно гайдлайну](https://rs.school/ru/docs/git-convention) + каждый ваш коммит должен содержать тайм-стемп.
...
- Задание будут проверяться посредством кросс-чека. [Инструкция по проведению cross-check](https://rs.school/ru/docs/cross-check-flow)
...
1. Выполнено всё из секции `Требования к репозиторию и как сабмитить задание` **+30**:
   ...
   - коммиты названы согласно [гайдлайну](https://rs.school/ru/docs/git-convention) + каждый коммит содержит тайм-стемп. **+10**
   - cтудент засабмитил ссылку на пулл реквест **+5**
   - Pull Request описан [по схеме](https://rs.school/ru/docs/pull-request-review-process#требования-к-pull-request-pr), и указаны все разрешения для проверки. **+5**
