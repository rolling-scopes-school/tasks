...
1. Выполнено всё из секции `Требования к репозиторию и как сабмитить задание` **+30**:
    ...
    - работа доступна по ссылке вида https://${YOUR_GITHUB_NAME}.github.io/cssMemeSlider/cssMemeSlider/ **+2**
    ...
    - Pull Request
      ...
      описана проделанная работа по всем критериям оценки и указаны все разрешения для проверки. **+5**
