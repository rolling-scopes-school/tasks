...
- Нажатие на `Help the shelter` перебрасывает нас на блок *Help*, на этой же странице (якорная ссылка).
- Нажатие на `Contacts` перебрасывает нас на блок *Footer*, на этой же странице (якорная ссылка).
...
- Нажатие на `Make a Friend` перебрасывает нас на блок *Our Friends*, на этой же странице (якорная ссылка).
...
- Нажатие на `Help the shelter` перебрасывает нас на блок *Help*, на странице *main* (якорная ссылка).
- Нажатие на `Contacts` перебрасывает нас на блок *Footer*, на этой же странице (якорная ссылка).
- Логотип находится слева. В логотипе используется текст.
- На странице обязательно должен присутствовать один элемент `<h1>`. Можно сделать его с текстом `Cozy House`.
