...
- Пагинация Должна быть интерактивной на доступных кнопках. Это значит, что с позиции (1) мы не можем уйти левее, т.е. в меньшую сторону. У серых кнопок должен обязательно присутствовать аттрибут `data-disabled` или класс-модификатор.
