...
- Задание будет проверяться целиком посредством кросс-чека согласно инстуркции, **которая появится 20 октября.** [Общая инструкция по проведению cross-check](https://rs.school/ru/docs/cross-check-flow)
