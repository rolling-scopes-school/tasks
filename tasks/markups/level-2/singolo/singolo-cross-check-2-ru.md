...
Дизайн должен полностью соотвествовать макету, который мы делали в предыдущих заданиях. Кроме кнопки формы, и текста в футере.  
Если есть какие-то недочеты, типа поплыл текст, сломалась сетка, или цвет далеко не соотвествует цвету оригинала, ставим **-3**.

### 768 px

Дизайн должен соотвествовать соотвествовать макету 768px. Кроме кнопки формы, и текста в футере.  
...
Дизайн должен соотвествовать соотвествовать макету 375px. Кроме кнопки формы.  
❗ Если элементы в блоках или текст хоть раз выходят за пределы экрана по горизонтали, ставим **-5**.
...
5. Если вызов меню не работает, или не происходит перехода на нужную позицию в ссылке, ставим **-3**.
...
Расстояние между элементами должно быть 10px. Если отступы отличаются больше, чем на 5px, ставим **-3**.
