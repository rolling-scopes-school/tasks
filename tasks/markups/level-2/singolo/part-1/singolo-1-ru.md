...
Создайте публичный репозиторий **_singolo_** в **вашем** Github-аккаунте и загрузите файлы HTML (`singolo1.html`), CSS (`singolo1.css`) и папку `assets` с изображениями и файлами шрифтов.
