...
- Есть 3 варианта сделать картинки. Выберите один:
...
- Трёхколоночный макет внизу. Лучше использовать [flexbox](https://habr.com/ru/post/467049/) или [grid](https://tuhub.ru/posts/css-grid-complete-guide).
