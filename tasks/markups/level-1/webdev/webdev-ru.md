...
❗ Важно: не учитваются погрешности отустпов и размеров в блоке **Header** (меню, логотип), и в блоке **Sign in** (величина самого блока и отустпы элементов до краев блока). Также не надо инспектировать элементы на предмет их физических размеров, если визуально они совпадают с наложенным макетом.   
