...
- После окончания разработки необходимо сделать Pull Request из ветки webdev в ветку master Требования к [Pull Request](https://rs.school/ru/docs/pull-request-review-process#требования-к-pull-request-pr). Мержить Pull Request не нужно
