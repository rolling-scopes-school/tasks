...
По условиям задания в ветке `gh-pages` должно быть не меньше трёх коммитов, названия которых начинаются с одного из префиксов `init:`, `feat: `, `fix: `, `refactor: `, `docs:` [Примеры имен коммитов](https://rs.school/docs/ru/git-convention#примеры-имен-коммитов).
