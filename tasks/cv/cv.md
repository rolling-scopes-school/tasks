...
- в этой части задания вы создаёте личный публичный репозиторий `rsschool-cv`, добавляете в него CV в формате markdown, деплоите его на `gh-pages`
...
- в этой части задания вы продолжаете работу в ранее созданном репозитории, создаёте ещё одну ветку, добавляете в неё файлы `index.html` и `style.css` с произвольным содержимым, деплоите их на `gh-pages`
- проверяется история коммитов и pull request
