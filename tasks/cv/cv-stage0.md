...
- вёрстка семантическая +15  
  В коде странице присутствуют следующие элементы:
   ...
   - элемент `<nav>` +5
- в footer есть ссылка на гитхаб автора работы, год создания приложения, [логотип курса](https://rs.school/images/rs_school_js.svg) со [ссылкой на курс](https://rs.school/js-stage0/) +5
