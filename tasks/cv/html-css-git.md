...
4. В ветке `rsschool-cv-html` разместите файлы `index.html` и `style.css`, предварительно добавив в них любое содержимое, так как загрузить пустые файлы CitHub не позволит.  
