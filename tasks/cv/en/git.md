...
- You can and should add a description to the Pull Request. [The Pull Request description should contain the following information](https://rs.school/docs/short-track/pull-request-requirements#pull-request-description-must-contain-the-following).
