...
5. Create a Pull Request from the `rsschool-cv-html` branch to the `main` branch.
   ...
   - Provide a description for the Pull Request following this [schema](https://rs.school/docs/pull-request-review-process#pull-request-requirements-pr).
...
- Cross-check instructions: [https://rs.school/docs/cross-check-flow](https://rs.school/docs/cross-check-flow).
