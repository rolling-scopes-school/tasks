...
Задание выполняется в ходе нескольких последовательных тасков.  
Автопроверяемые таски:  
- [Markdown & Git](git-markdown.md)
- [HTML, CSS & Git Basics](html-css-git.md)  

Таски , проверяемые кросс-чеком:
- подготовительный этап (stage#0) - [CV. Cross-Check](html-css.md)
- основной этап (stage#1) - [CV](cv.md)
