...
При сообщении после проверки "... try in ten minutes" попробуйте сделать сабмит позже - это означает, что слишком много людей сейчас жмут на кнопку и очередь запросов переполняется, ваши повторные многочисленные нажатия submit только удлинят это ожидание.
