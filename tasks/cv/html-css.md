...
> Сабмит задания будет доступен в rs app после старта основного набора 05.09.2021.
...
3. Проверьте соответствие вашего CV требованиям задания, самостоятельно оцените свою работу согласно предложенным [Критериям оценки](html-css#Критерии-оценки), внесите необходимые изменения
...
Для сабмита задания зайдите в rs app https://app.rs.school/ вкладка **Cross-Check: Submit**, выберите задание **HTML & CSS** и добавьте в форму ссылку на открытый Pull Request из ветки `cv-html-css` в ветку `main`.
