...
- Дополнительная функциональность.
  ...
  - подсветка клавиш виртуальной клавиатуры при кликах по клавишам физической клавиатуры. Подсвечиваются алфавитно-цифровые клавиши и клавиша пробел. Отсутствие подсветки функциональных клавиш не является поводом для снижения баллов. +5
  - озвучивание нажатия клавиш - при печати воспроизводился звук пишущей машинки, или другие звуки. Есть возможность отключить воспроизведение звука при печати +5
  - клавиатура адаптируется под размер страницы. Минимальная ширина страницы, при которой проверяется корректность отображения и работы клавиатуры, 500рх +5
  - голосовой ввод текста. В качестве примера можно посмотреть как работает голосовой ввод текста в Google Документы ([Google Документы](https://docs.google.com/document/u/0/) => Пустой файл => Инструменты => Голосовой ввод) +5
