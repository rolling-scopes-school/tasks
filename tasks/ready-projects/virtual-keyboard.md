...
- **Базовая функциональность**
  - при клике мышкой по клавишам с символами, эти символы отображаются в окне ввода. Есть клавиша пробел
...
- **Смена языка en/ru**
  ...
  - при переключении языка на других клавишах клавиатуры отображаются символы выбранного языка
...
- **Подсветка клавиш виртуальной клавиатуры при кликах по клавишам физической клавиатуры**
  - нажатие на клавишу физической клавиатуры подсвечивает соответствующие алфавитно-цифровые клавиши, клавиши с символами, клавишу пробел виртуальной клавиатуры
  - символы нажатых клавиш выводятся в окне для ввода текста
...
- **Озвучивание нажатия клавиш**
  - при печати воспроизводится звук пишущей машинки, или другие звуки
