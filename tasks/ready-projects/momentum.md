...
- **Смена фонового изображения**
  ...
  - изображения пролистываются в том же порядке, в котором они менялись бы в реальном времени (утро, день, вечер, ночь), начиная с того, которое соотвествует текущему времени суток. При обновлении страницы формируется новый список фоновых изображений
  ...
  - плавная смена фоновых изображений при обновлении страницы 
- **Цитата дня**
...
- **Прогноз погоды**
  ...
  - указанный город и прогноз погоды для него отображаются при обновлении страницы
