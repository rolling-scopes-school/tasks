...
При оценке cross-check максимальное количество баллов 230.(Студенты проверяют у студентов)
...
- Не отображается температура в текущий промежуток времени - **2 баллов**
- Не отображается описание погоды (summary), ощущаемая температура (apparent temperature), скорость ветра(м/с), влажность(%) - **3 баллов**
- Не отображается иконка погоды - **2 баллов**
...
В случае отображения данных:
 ...
 В случае отображения дня недели:
  - день недели отображается в не полном формате - **2 баллов**
...
- Не реализованы юнит-тесты – 2 балла за каждый тест, но не больше **20 баллов**
