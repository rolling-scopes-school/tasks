...
- Не выполнены требования к коду 
  - html-элементы не генерируются в js - **5 баллов**
  - js код не разбит на модули - **10 баллов**
  - не используется webpack - **10 баллов**
  - не используются editorconfig, eslint, eslint-config-airbnb-base, babel  - **3 балла за каждый**
...
– меньше 6 коммитов, ошибки в названиях коммитов, ошибки в пулл реквэсте - **10 баллов**
