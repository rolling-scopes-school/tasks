...
2) Если вы считаете, что присутствуют серьёзные отклонения, и они, очевидно, не являются фичей - выставляем 50% от количество баллов.
...
- верстка прототипа приложения адаптивная и респонсив – **20 баллов**    
