...
Ссылка по сдаче заданий укащана не корректно.
Я предположил, что возможно на самом сайте где-то можно найти страницу по сдаче заданий. Нашел лишь только это https://app.rs.school/course/student/cross-check-submit?course=rs-2020-q1 но там список заданий пуст.
Данное задание я выполнинл. Вот ссылка=: https://htmlacademy.ru/profile/id877737
