...
За данную работу не предусмотрены штрафные балы. Однако, организаторы могут снизить команде бал за недостаточный функционал приложения (если изначальное описание проекта не совпадает с конечной реализацией)

## Оценивание задания

Оценивание задания происходит в процессе группового cross-check и презентации работы. Задания в ходе cross-check оцениваются по критериям оценивания, описанным в другом файле. Презентация оценивается отдельно членами жюри.
...
**Максимальный балл за задание - _640_ баллов**  
Из них:
