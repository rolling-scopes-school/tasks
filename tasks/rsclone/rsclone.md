...
- История коммитов должна отображать процесс разработки приложения и соответствовать [требованиям к коммитам](https://rs.school/ru/docs/git-convention).
- Демо-версия приложения размещается на `gh-pages`, `netlify`, либо на другом подобном хостинге.
- После выполнения задания или дедлайна, создайте pull request из ветки `develop` в ветку `master`/`main` в соответствии с [требованиями к pull request](https://rs.school/ru/docs/pull-request-review-process#требования-к-pull-request-pr).
