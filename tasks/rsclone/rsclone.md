...
* Т.к. у студентов есть творческие идеи которые они бы хотели реализовать, предлагаю в качестве эксперимента добавить пункт отдельный пункт, внедрение какой-либо интересной фичи которой нет в данном списке (оценка 20 балов если фича сложная 40б)
