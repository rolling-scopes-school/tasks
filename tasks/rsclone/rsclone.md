...
- Для участия в проекте необходимо заполнить таблицу:
  - [Проекты](https://docs.google.com/spreadsheets/d/1m86KTa79xg434mKeiNOzbI1EBOQvTRB495gMB_96E6M/edit?usp=sharing) для уже сформировавшихся команд
  - Так же вы можете заполнить свои данные в таблицу на вкладке [Разработчики](https://docs.google.com/spreadsheets/d/1wkE1G8P9iyCjyglJK27mEZS6lcMCze9XGlTy0o07pjQ/edit?usp=sharing) для студентов, которые ищут себе команду.
...
- **После дедлайна** команда должна подготовить и провести презентацию своего проекта.

### Для Ментора

**Меноры**, студенты которых учавствуют в разработке проектов, **не должны писать код**, их поддержка должна заканчиваться на советах по лучшим путям разработки, организации команды и презентации инструментов, которые команда могла бы использовать в проектах. В случае, если в команде проекта оказывается несколько студентов от разных менторов, менторам необходимо также объединиться в команду и координировать советы во избежание противоречий в них.
...
**Максимальный балл за задание - _500_ баллов**  
Из них:
...
- Максимальное количество баллов, которое можно получить за разработку приложения - 450.
