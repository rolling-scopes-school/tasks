...
Меноры, студенты которых учавствуют в разработке проектов, не должны писать код, их поддержка должна заканчиваться на советах по лучшим путям разработки, организации команды и презентации инструментов, которые команда могла бы использовать в проектах. В случае если в команде проекта оказывается несколько
студентов от разных менторов - менторам необходимо так же объединиться в команду и координировать советы, во избежание противоречий в них.  
