...
\* Web-приложения - это интерактивные компьютерные приложения, разработанные для сети интернет, позволяющие пользователям вводить, получать и манипулировать данными с помощью взаимодействия.
## Тематика приложения
...
- требуется использовать Angular / React / Vue
...
- можно использовать RabbitMQ/Kafka
...
### Что такое фича:
1. Она должна быть ценна для бизнеса.
2. Она должна быть оценена - она должна быть достаточно определена, чтобы команда разработчиков могла дать оценку работы, связанной с её реализацией.
3. Она должен быть достаточно маленькой,поэтому, если она слишком большая, её следует разбить.
4. Она должна быть тестируемой - вы должны понимать, какое автоматическое или ручное тестирование должна пройти функция, чтобы быть приемлемой для клиента.
...
* Используется RabbitMQ/Kafka (10 баллов)
* Используется Docker (10 баллов)
