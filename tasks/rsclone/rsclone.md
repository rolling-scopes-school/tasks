...
\* Здесь и дальше в тексте задания под приложением понимаем игру или приложение, которое создаётся командой в ходе выполнения проекта. 
...
- кроме перечисленных в предыдущем пункте требований pull request должен содержать:
  ...
  - видео, в котором демонстрируются все реализованные фичи. Это может быть как видео с обзором приложения, так и можно снять отдельное видео для проверяющих
...
- При оценке приложения команда **самостоятельно** составляет список реализованных фич и ожидаемое количество баллов за каждую из них. Каждая реализованная фича оценивается от 10 до 40 баллов в зависимости от её сложности.
...
Каждая команда **самостоятельно** решает какие фичи будет реализовывать и **самостоятельно** определяет количество баллов (от 10 до 40) за каждую реализованную фичу. Общее количество баллов за все реализованные фичи не может быть больше 320.
...
* Есть возможность переключения 2 и более языков (10 баллов за каждый дополнительный язык, но не более 30 баллов)
...
* Действие игры происходит на разных уровнях, картах, локациях, используются анимированные переходы между уровнями, анимации победы, поражения (20 баллов)
...
* Возможность работать на нескольких вкладках приложения, например как разные рабочие листы в exсel, макеты в фигме (20 баллов) 
...
##### Работа с кодом:
* Использован какой-либо data flow паттер MVC/MVVM/Redux/etc (20 баллов)
* Использован eslint, eslint-config-airbnb-base (10 баллов)
* Понятный, читаемый код. Имена переменных и функций отражают то что в них содержется/то что они делают. Функция выполняет одно действие. Повторение логики сведено к минимуму. (20 баллов)
...
Вы можете **самостоятельно** добавить отдельные пункты по внедрению каких-либо интересных фич, которых нет в предложенном выше списке и **самостоятельно** определить количество баллов за каждый из них. Оценка за каждую реализованную фичу от 10 до 40 баллов, в зависимости от её сложности, но не более 160 баллов за всю предложенную вами дополнительную функциональность.
