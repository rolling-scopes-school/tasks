...
### Сессия пользователя
При обновлении страницы сохраняется предыдущее состояние приложения: выбранный цвет, инструмент, размер холста, загруженное изображение. Если поверх изображения были сделаны рисунки карандашом или заливкой, их сохранять не нужно. Эта функция должна быть реализована с помощью localStorage API. Дополнительных запросов на сервер при обновлении страницы быть не должно.
...
- [ ] **+5** - есть возможность изменения размера канваса. При изменении размера канваса предыдущее изображение сохраняется и занимает весь размер канваса
- [ ] **+5** - поверх загруженного изображения можно рисовать карандашом. Карандаш рисует непрерывную линию.
- [ ] **+5** - поверх загруженного изображения работает инструмент заливка. Заливка заливает только область определённого цвета.
...
- [ ] **+10** - возможность загрузки изображения по указанному пользователем ключевому слову
