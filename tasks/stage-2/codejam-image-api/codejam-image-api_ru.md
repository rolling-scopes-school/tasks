...
* для обычной сложности размер поля канваса - 128х128, размер самого канваса - 512px, размер элемента поля - 4px. 
...
* Кнопку загрузки случайного изображения для города
* Поле, в котором можно указать город, изображение которого будет загружаться на канвас

Для задания повышенной сложности
* Панель для переключения размера поля 128x128 или 256x256, или 512 x 512. Канвас при этом остается размером 512px (меняется размер элемента поля - 4x4, 2x2 или 1x1 соответственно).
