...
## Формирование команд
 - Оптимальное количество участников команды - три человека, также допустимо выполнение задания вдвоём или в одиночку.
...
Рекомендуется создать локальную копию бэкенда, так как у бесплатного плана в heroku есть свои ограничения, а так будет выполняться несколькими людьми. Плюс вы можете вносить в копию свои изменения, если считаете их необходимыми для вашей функциональности. Для этого:
