...
### Электронный учебник +80
  ...
  На каждой странице учебника отображается:
    ...
    - навигация по страницам учебника со стрелками для перехода к следующей и предыдущей страницам и номером текущей страницы
...
- [ ] написано не меньше двадцати Unit test, использующих различные [методы jest](https://jestjs.io/docs/ru/expect) +20
