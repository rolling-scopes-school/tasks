...
6. Фильтры по значению +30  
   ...
   Для фильтров одного типа выбираются игрушки, которые соответствуют хоть одному выбранному фильтру. Например, можно отобразить снежинки и колокольчики. Или белые и синие игрушки. Или большие и средние.
7. Фильтрация по нескольким фильтрам разного типа +20  
   Для фильтров разного типа выбираются те игрушки, которые соответствуют всем выбранным фильтрам.  
...
9. Сохранение настроек в local storage +10
   - выбранные пользователем фильтры и порядок сортировки, добавленные в избранное игрушки сохраняются при перезагрузке страницы +10
9. Поиск +30
