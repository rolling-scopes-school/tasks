...
- Рекомендуется, что нажатие на карточку перебрасывает нас на *страницу с соответствующим животным*. Если такого животного нет среди 4х представленных, то может ничего не происходить.
