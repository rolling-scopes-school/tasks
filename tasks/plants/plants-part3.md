...
1. При нажатии на кнопки:`Gargens`,`Lawn`,`Planting` кнопки меняют вид и карточки услуг становятся размытыми/четкими (эффект blur) в разделе `service` +50 
   - Исходное состояние: все кнопки неактивны, все карточки услуг без эффекта blur. Проверка: нажимаем любую кнопку, эта кнопка становится активной, карточки выбранной услуги остаются без эффекта blur, карточки остальных услуг принимают эффект blur + 20
   - Исходное состояние: ровно одна кнопка активна, карточки выбранной услуги без эффекта blur, остальные — с blur. Проверка: нажимаем еще одну кнопку, теперь две кнопки активны и карточки, соответствующие этим услугам, без эффекта blur, остальные - с blur. Далее нажимаем оставшуюся неактивную кнопку, тогда она становится активной, а две остальные — неактивными. C эффектом blur только карточки выбранной услуги. Далее нажимаем на эту кнопку еще раз, она становится неактивной, теперь все кнопки неактивны и все карточки услуг без эффекта blur. Далее делаем любые две кнопки активными и затем на одну из них нажимаем еще раз, она становится неактивной, с эффектом blur только карточки неактивных кнопок. +20
