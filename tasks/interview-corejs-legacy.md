# CoreJS Interview #2 (Legacy Version)

> **This is the previous version of the interview, preserved for reference.**
> For the current version, see [interview-corejs.md](./interview-corejs.md).
> For rationale behind the changes, see [interview-corejs-changelog.md](./interview-corejs-changelog.md).
