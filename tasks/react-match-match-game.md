...
* scoreboard data should be requested from the API
* new score result should be sent to the API where it will be saved
...
* redux middlewares are used (e.g thunk, logger), state is logilaly splitted using combineReducers (75-85)
