...
- Pixel Perfect не требуется. Основное требование - визуальное сходство вёрстки и страницы макета. Считается ошибкой отступление от Pixel Perfect больше чем на 5рх по горизонтали и 10рх по вертикали.
