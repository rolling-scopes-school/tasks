...
| ---------------- | ----------- | ----------- |
| 06.12.2020 23:59 | rs-css      | rs-css      |
...
- в блоке со списком уровней игры, есть возможность переходить к определённому уровню кликая по его номеру; возле каждого уровня отображается выполнен он, или нет, или открыт кликом по кнопке Help. Текущий уровень подсвечен. При перезагрузке приложение открывается на этом же уровне. Есть кнопка, позволяющая сбросить прогресс и начать прохождение игры заново
...
**Максимальный балл за задание: 170 баллов при кросс-чеке / 170 баллов при проверке ментором**

## Требования к коду +170 (оценивает только ментор)
...
## Требования к функционалу приложения +170 (оценивается в ходе cross-check)
...
- [ ] в приложении есть кнопка Help для тех случаев, когда пользователь не сумеет угадать нужный селектор. Клик по кнопке Help отображает правильный ответ в окне для ввода кода. Ответ выводится с эффектом печати текста (плавное появление текста по буквам). 
- [ ] возле каждого уровня игры отображается выполнен он, или нет, или открыт кликом по кнопке Help. Есть кнопка, позволяющая сбросить прогресс и начать прохождение игры заново +10
