...
- the commit history should display application development process. [Commit requirements](https://rs.school/ru/docs/git-convention)
...
[How to evaluate tasks in Cross check](https://rs.school/ru/docs/cross-check-flow). In the comments to the assessment, it is necessary to indicate which items are not fulfilled or partially fulfilled.
