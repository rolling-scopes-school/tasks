...
- организация командной работы описана в [Документации курса](https://docs.rs.school/#/final-task?id=Организация-командной-работы) <!-- TODO: страница с организацией командной работы в документации отсутствует -->
...
- главная страница приложения содержит:
  ...
  - footer со ссылками на гитхабы авторов приложения, год создания приложения, [логотип курса](https://rs.school/_next/static/media/rss-logo.c19ce1b4.svg) со [ссылкой на курс](https://rs.school/courses/reactjs). footer отображается на всех страницах приложения за исключением мини-игр.
...
- форма для проверки задания <https://rs-lang-cross-check.netlify.app/>
