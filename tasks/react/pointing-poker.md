...
### Настройки(настройки игры + лобби для дилера)
  - страница с настройками состоит из трех главных блоков:
    - запуск игры. В данной секции дилер должен иметь возможность:
      ...
      - отменить игру. При отмене игры статус игры переходит в состояние "не активная", дилер видет сообщение, что игра отменена успешно/неуспешно, а все пользователи удаляются из лобби(если реализовано). 
...
## Критерии оценивания
**Максимальный балл за задание 530**  
Из них:
- 430 баллов за приложение
...
- [ ] приложение не поддерживает проведение нескольких игр одновременно -40 
