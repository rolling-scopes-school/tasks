# CoreJS Interview #1 (Legacy Version)

> **This is the previous version of the interview, preserved for reference.**
> For the current version, see [interview-basic-coreJS.md](./interview-basic-coreJS.md).
> For rationale behind the changes, see [interview-basic-coreJS-changelog.md](./interview-basic-coreJS-changelog.md).
