...
2. На карточке игрушки есть её изображение, название, текстом или условным значком обозначено количество экземпляров, год покупки, форма, цвет, размер, является ли игрушка любимой +10
...
8. Внешний вид и функционал интерактивной страницы избранного создаётся на основе игры [Наряди Ёлку](https://www.karusel-tv.ru/games/tree). На странице избранного есть слоты с карточками всех выбранных игрушек, ёлка, меню с настройками. Со страницы избранного можно перейти на главную страницу приложения. Выполняются требования к вёрстке +10
...
9. Есть кнопка "Ёлочка гори" или аналогичная, при клике по которой игра "Наряди ёлочку" заканчивается, слоты с игрушками и меню скрываются, воспроизводятся дополнительные эффекты анимации, выводится уведомление "До Нового года осталось" с таймером, отсчитывающим время до Нового года в днях, часах, минутах, секундах, появляется поздравление с наступающим Новым годом +10
...
11. Дополнительный, не указанный в задании, сложный в реализации функционал, улучшающий качество приложения и/или удобство пользования им +10
