...
- для работы приложения надо сделать экраны логина и регистрации нового пользователя
- при успешном логине приложение загружается со стартового экрана. При клике по кнопке "Start game" открывается основной экран приложения
