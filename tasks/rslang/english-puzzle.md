...
- стартовый экран содержит название приложения, краткую инструкцию для пользователя, кнопку Start
...
- стартовый экран, основная страница приложения и страница статистики занимают весь экран полностью. Если на одной странице отображается содержание второй, это ошибка.

## Работа приложения

- для работы приложения необходимо сделать страницы логина и регистрации нового пользователя
- вход в систему выполняется только один раз. При перезагрузки страницы появляется стартовый экран приложения
- если пользователь успешно вошел в систему, приложение загружается со стартового экрана. При клике по кнопке "Start" открывается основная страница приложения
