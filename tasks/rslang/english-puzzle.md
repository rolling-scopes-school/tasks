...
- в блоке с результатами собираются предложения и находятся уже собранные предложения. Для каждого предложения отводится одна строчка. Ширина всех предложений одинакова. Предложения, в которых больше 10-12 слов, из игры можно исключить.
...
- стартовый экран, основной экран приложения и страница статистики занимают весь экран полностью. Если на одной странице отображается содержание второй, это ошибка.
...
- на странице статистики есть кнопки "Continue", при клике по ней открывается следующий раунд игры, и Statistic, при клике по которой открываются результаты ранее сыгранных игр
