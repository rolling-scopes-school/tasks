...
**Максимальный балл за задание: 150 баллов при кросс-чеке / 150 баллов при проверке ментором**
...
- [ ] слова между блоком с результатами и блоком с исходными данными можно перетягивать мышкой +10
...
- [ ] минимальная ширина страницы, при которой она отображается корректно – 320 рх. На разрешениях меньше десктопного функционал приложения сохраняется в той мере, в которой это возможно +10 
...
Так же, если вам чего-то не хватает в текущей реализации, то вы можете форкнуть backend репозиторий, изменить его под свою реализацию, задеплоить и использовать.  
