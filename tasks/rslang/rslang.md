...
- в предложенный в задании функционал могут вноситься изменения и дополнения, если они позволяют улучшить качество приложения с точки зрения потенциального пользователя
...
- **"Своя игра" +120**
  ...
  - [ ] оригинальная идея, сложный механизм игры, высокое качество его реализации +30	
  - [ ] использованы новые подходы, реализованы новые возможности, которых не было в предыдущих играх +40	
