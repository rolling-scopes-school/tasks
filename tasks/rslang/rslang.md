...
- [ ] Рассказать вкратце о функциональности вашего приложения, что было реализовано +15
- [ ] Обосновать полезность приложения для потенциальных пользователей +30
- [ ] Рассказать про процесс командной работы, по которому вы работали в рамках задания +25
- [ ] Рассказать о трудностях, возникших в ходе выполнения задания и их решения + 30
