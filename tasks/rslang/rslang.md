...
- использование Angular / React / Vue только с согласия ментора и всех участников команды
...
**Максимальный балл за задание 580**
...
- **Мини-игры  +50 баллов за каждую игру**
  ...
  **Общие требования к мини-играм:**
  ...
  - [ ] качественный дизайн повторяющий дизайн прототипа или являющийся его улучшеной копией. Есть стартовый экран +10
  - [ ] высокое качество реализации функционала игры. Мини-игра полностью повторяет работу прототипа или является его улучшеной копией +30
...
- **"Своя игра" +50** 
  ...
  - [ ] игра интересная, полезная, увлекательная, не является клоном предыдущих игр +10
  - [ ] оригинальная идея, сложный механизм игры, высокое качество его реализации +10
  - [ ] использованы новые подходы, реализованы новые возможности, которых не было в предыдущих играх +10
  - [ ] ведётся краткосрочная и долгосрочная статистика мини-игры. Для хранения статистики используется бекэнд +10   
- **Авторизация +20**
...
- меньше 5 коммитов или меньше 2 pull request от каждого активного участника команды -50 баллов (оценивает только ментор)
