...
- дизайн конечного приложения должен выглядеть целостно: внешний вид соответствуют приложению, которым будут пользоваться потенциальные пользователи, картинки для карточек слов и категорий использованы хорошего качечтва и в самом приложении они имеют одинаковый размер, все элементы пользовательского интерфейса функционируют исправно, разметка не разваливается при изменении разрешения
