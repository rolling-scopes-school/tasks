...
### Выполнены требования к коду – 110 баллов (оценивает только ментор)
...
- [ ] подключены и используются webpack, eslint, eslint-config-airbnb-base +20
- [ ] приложение разбито на отдельные модули +30
- [ ] используются фичи ES6 и выше +20
