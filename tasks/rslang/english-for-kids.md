...
## Критерии оценки:
**Максимальный балл за задание: 170 баллов при кросс-чеке / 280 баллов при проверке ментором**   
...
### Выполнены требования к коду – 150 баллов (оценивает только ментор)

- [ ] дублирование кода сведено к минимуму, не используются магические числа, используются осмысленные имена переменных и функций, оптимальный размер функций и т.д. +40
- [ ] подключены и используются webpack, eslint, eslint-config-airbnb-base +30
- [ ] приложение разбито на отдельные модули +30
- [ ] используются фичи ES6 и выше +30
- [ ] методы и функции не превышают 40 строк +20
