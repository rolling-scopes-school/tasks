...
Все эти свойства уже указывались в [советах](portfolio-part1.md) к первой части задания. Просто перечитайте их ещё раз, если столкнулись с проблемой несовпадения фона секций при уменьшении ширины страницы.
