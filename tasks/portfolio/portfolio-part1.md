...
Вам необходимо сверстать страницу согласно [макету](https://www.figma.com/file/6yRTVMur4ijM1w5Fj1gDPl/Portfolio)  
Ширина контента 1440рх не должна меняеться при изменении размера окна браузера.
...
1. Вёрстка валидная +10
   ...
   - валидной вёрстке соответствует надпись "Document checking completed. No errors or warnings to show." В таком случае баллы выставляем полностью.
...
2. Вёрстка семантическая +26  
   ...
   - пять заголовков `<h2>` (количество секций минус одна) +2
