...
1. ветка portfolio будет содержать первую часть задания, приступая ко второй части создайте ветку portfolio-part2 от ветки portfolio что позволит продолжить с того же места
на котором вы остановились в первой части
