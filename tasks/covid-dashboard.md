...
| ---------------- | --------------- | -----------------|
| 20.12.2020 23:59 | covid-dashboard | covid-dashboard  |
...
<center>Онлайн-карта распространения Covid-19 от Университета Джона Хопкинса</center>  
<center>Структуру и внешний вид этого проекта можно использовать в качестве образца</center> 
...
Данные в приложении должны обновляться ежедневно, в соответствии с обновлением данных, предоставляемых API. В приложении отображается дата, за которую отображаются данные.

## Особенности задания

Задание рекомендуется выполнять вдвоём. Группы формируются по желанию студентов.  
Вне зависимости от того, выполнялся таск вдвоём или самостоятельно, каждый студент сабмитит работу и получает за неё баллы по результатам кросс-чека. 

## Требования к репозиторию

- если вы работаете вы над таском вдвоём, задание выполняется в личном приватном репозитории одного из студентов, работающих вместе.
...
- в футере приложения есть ссылки на гитхабы авторов приложения, год создания, логотип курса со ссылкой на курс
...
- **Примеры приложений** 
  - [Онлайн-карта распространения Covid-19 от Университета Джона Хопкинса](https://coronavirus.jhu.edu/map.html) 
