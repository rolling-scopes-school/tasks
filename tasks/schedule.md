...
**Расписание содержит:**
- минимум 10 рядов, но может быть расширено до 100 рядов
...
**Максимальный балл за задание: 560 баллов** 
...
- **Просмотр расписания +160**
  ...
  - [ ] возможность сохранения расписания в виде таблицы, списка или календаря в файле. Оптимальные форматы файлов для сохранения расписания команда выбирает самостоятельно  + 10 баллов за каждый формат файлов, но не больше 20 баллов
...
- **Редактирование расписания +180**  
  ...
  - [ ] редактирование расписания организовано понятно и удобно + 20
  ...
  - [ ] редактирование страницы задания организовано понятно и удобно + 20 
