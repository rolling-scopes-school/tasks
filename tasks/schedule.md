...
- работа ведётся в группах. [Описание процесса командной работы](https://docs.rs.school/#/final-task?id=Организация-командной-работы) <!-- TODO: страница с организацией командной работы в документации отсутствует -->
