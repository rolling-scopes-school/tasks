...
- создаваемое вами приложение является частью [rs app](https://github.com/rolling-scopes/rsschool-app) и должно органично интегрироваться в него, не нарушая общую концепцию, оформление, логику работы
...
**Расписание содержит:**
- минимум 10 рядов, но может быть расширено до 30-50 рядов
...
- просмотр расписания в виде таблицы, календаря либо списка
- просмотр детальной информации об отдельных заданиях расписания. 
- сохранение расписания в текстовом файле
...
- необходимо использовать TypeScript для более простой интеграции созданного приложения в rs app
...
4. Составьте концепт вашего приложения с указанием тех изменений и усовершенствований, которые необходимо внести в текущее расписание, основываясь на результатах своих исследований.

## Критерии оценки:

**Максимальный балл за задание: 520 баллов** 

- **Создание концепта приложения +30**
  - [ ] выполнены и оформлены в виде markdown файла или документа Google Docs требования пункта 'Создание концепта приложения' + 10
  - [ ] список изменений и усовершенствований, которые необходимо внести в приложение, выглядит полным, исчерпывающим, содержит оригинальные идеи и может использоваться в качестве техзадания при выполнении проекта + 10
...
- **Просмотр расписания +180**
  - [ ] выполнены требования к оформлению приложения - по 10 баллов за каждый выполненный пункт требований + 30
  ...
  - [ ] оптимальные структура и внешний вид страницы задания + 10
  - [ ] страница задания содержит текст, ссылки, фото и видео + 10
  - [ ] значения в ячейках таблицы отображаются и форматируются согласно типу находящихся в них данных + 10  
  - [ ] при просмотре приложения есть возможность выбора часового пояса + 10  
  ...
  - [ ] при просмотре расписания есть возможность изменять цвет фона и цвет шрифта для выделения заданий разных типов + 10
  - [ ] возможность сохранения расписания в текстовом файле + 10
  ...
  - [ ] ряд таблицы или списка можно выделить кликом. Выделенный ряд должен отличатся визуально +10 
  - [ ] с выделенным рядом можно произвести какие-то действия, например, скрыть. Скрытый ряд можно отобразить +10
  - [ ] с зажатым shift можно выделить несколько рядов таблицы и произвести с ними какие-то действия, например, скрыть. Скрытые ряды можно отобразить +10
  
- **Редактирование расписания +180**  
  - [ ] у ментора есть возможность редактирования расписания + 20
    Редактируется только основная форма расписания - таблица. Расписание в виде календаря или списка автоматически генерируются на основе введённых в таблицу данных
  - [ ] редактирование расписания организовано максимально понятно и удобно + 20
  - [ ] в процессе редактирования ментор сразу видит как будет выглядеть таблица с расписанием + 20
  - [ ] при редактировании расписания дату и время можно выбрать на календаре/ часах + 20
  ...
  - [ ] у ментора есть возможность редактирования страницы задания + 20
  - [ ] редактирование страницы задания организовано максимально понятно и удобно + 20 
...
- **Оптимизация расписания +110**
  ...
  - [ ] реализована [виртуализация рядов](https://web.dev/virtualize-long-lists-react-window/) для отображении большого объёма данных, применяются другие способы оптимизации производительности приложения +20
  - [ ] в расписание внесены дополнительные не указанные в задании полезные усовершенствования, которые облегчают работу с ним, делают его более удобным и функциональным, улучшают внешний вид и т.д. +10 баллов за каждое усовершенствование*, но не больше 80 баллов
...
- **Штрафные баллы** 
  ...
  - [ ] проблемы с производительностью, отображением на экране, баги в работе приложения -10 баллов за каждую выявленную ошибку
...
- для удобства проверки задеплоенная версия приложения должна содержать отдельную страницу со ссылками на
  ...
  - документацию к коду 
  - любые другие дополнительные материалы, которые помогут проверяющим оценить ваш проект
