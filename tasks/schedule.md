...
- **Целесообразность интеграции в rs app +40**
  - ваша группа рекомендует данное приложение для интеграции в rs app. Ссылки на рекомендованные вашей группой работы добавьте, пожалуйста, в эту форму https://forms.gle/uGygGwL3CL3TszwJ8 + 40
