...
5. Общие требования к верстке **+20**
   ...
   - при уменьшении масштаба страницы браузера вся вёрстка (контент) размещается по центру, а не сдвигается в сторону +2. Для этого может быть создана обертка вокруг всей страницы или каждой секции, которая выравнивается по центру. Фон секций, `footer`, `header` - тянется на всю ширину экрана. Изображение библиотеки в секции `Welcome` - занимает всю ширину экрана.
