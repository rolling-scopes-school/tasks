...
- **Ограниченная карусель в блоке `About`**
  ...
  2. На экране шириной 1440px проверяем, чтобы было доступно 2 другие (скрытые для мобильной версии) картинки. При каждом нажатии выезжает следующая, и так до границ справа и слева. +2
  ...
  5. На экране шириной 768px проверяем, чтобы не было доступно 2 других скрытых картинок. Для этого меняем разрашение и перезагружаем страницу. Теперь доступных перемещений становится 5. +2
