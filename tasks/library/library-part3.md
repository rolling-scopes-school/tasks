...
- **Ограниченная карусель в блоке `About`**
  1. Карусель реагирует на нажатие кнопок (в мобильной версии стрелочки слева и справа, в десктоп версии - кнопки под каруселью) и происходит анимация перелистывания. +15
  ...
  3. Выделенные кнопки под каруселью (имеется ввиду кнопка соответствующая активному слайду и которая имеет коричнеый цвет) - неактивные. +2
