...
\* Очень желательно включить в перечень тасков ссылку на видеозапись презентации, которая демонстрирует ваши знания английского языка. В дополнение (или как альтернативу презентации) можно записать отдельное видеообращение на 1-2 минуты.
...
- [ ] используются современные, сложные, интересные элементы оформления сайта: параллакс, фоновое видео, эффектная типографика в стиле readymag и т.д (примеры таких элементов приведены в материалах к заданию) +20
