export const criteria = [
  ...
  {
    id: 7,
    text: 'Несоответствие снимку макета, наложенному на страницу. Визуальные отличия элементов <strong>Header</strong> составляют более двух пикселей (2px)',
    mod: -3,
  ...
  {
    id: 8,
    text: 'Несоответствие снимку макета, наложенному на страницу. Визуальные отличия элементов секции <strong>Slider</strong> составляют более двух пикселей (2px)',
    mod: -3,
    i: "Если нарушение UI происходит в одном блоке, и съезжают со своего места все остальные, то при переходе проверки на следующий блок, мы его выравниваем с наложенным изображением. ! Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 9,
    text: 'Несоответствие снимку макета, наложенному на страницу. Визуальные отличия элементов секции <strong>Services</strong> составляют более двух пикселей (2px)',
    mod: -3,
    i: "Если нарушение UI происходит в одном блоке, и съезжают со своего места все остальные, то при переходе проверки на следующий блок, мы его выравниваем с наложенным изображением. ! Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 10,
    text: 'Несоответствие снимку макета, наложенному на страницу. Визуальные отличия элементов секции <strong>Portfolio</strong> составляют более двух пикселей (2px)',
    mod: -3,
    i: "Если нарушение UI происходит в одном блоке, и съезжают со своего места все остальные, то при переходе проверки на следующий блок, мы его выравниваем с наложенным изображением. ! Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 11,
    text: 'Несоответствие снимку макета, наложенному на страницу. Визуальные отличия элементов секции <strong>About</strong> составляют более двух пикселей (2px)',
    mod: -3,
    i: "Если нарушение UI происходит в одном блоке, и съезжают со своего места все остальные, то при переходе проверки на следующий блок, мы его выравниваем с наложенным изображением. ! Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 12,
    text: 'Несоответствие снимку макета, наложенному на страницу. Визуальные отличия элементов секции <strong>Get a Quote</strong> составляют более двух пикселей (2px)',
    mod: -3,
    i: "Если нарушение UI происходит в одном блоке, и съезжают со своего места все остальные, то при переходе проверки на следующий блок, мы его выравниваем с наложенным изображением. ! Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 13,
    text: 'Несоответствие снимку макета, наложенному на страницу. Визуальные отличия элементов <strong>Footer</strong> составляют более двух пикселей (2px)',
    mod: -3,
    i: "Если нарушение UI происходит в одном блоке, и съезжают со своего места все остальные, то при переходе проверки на следующий блок, мы его выравниваем с наложенным изображением. ! Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 14,
    text: 'Текст <u>в местах, где находится несколько строк</u>, <strong>должен быть растянут равномерно на ширину блока</strong>. Отсутствует свойство text-align: justify или его аналог в секции <strong>Services</strong>',
    mod: -3,
    i: "Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 15,
    text: 'Текст <u>в местах, где находится несколько строк</u>, <strong>должен быть растянут равномерно на ширину блока</strong>. Отсутствует свойство text-align: justify или его аналог в секции <strong>About</strong>',
    mod: -3,
    i: "Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
    id: 16,
    text: 'Текст <u>в местах, где находится несколько строк</u>, <strong>должен быть растянут равномерно на ширину блока</strong>. Отсутствует свойство text-align: justify или его аналог в секции <strong>Get a Quote</strong>',
    mod: -3,
    i: "Исключение составляет сам текст, а именно ширина слов и отступ между буквами. Их не учитываем при сопоставлении"
  },
  {
