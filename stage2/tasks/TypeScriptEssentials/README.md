...
2. Once you complete a module, **open and don't merge** a pull request (PR) from `typescript-essentials` to `main`. Format the PR description in accordance with the [PR Description requirements](https://rs.school/docs/pull-request-review-process?id=description-example).
