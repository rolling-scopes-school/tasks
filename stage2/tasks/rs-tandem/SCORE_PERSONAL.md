...
**Поток оценки:** студент заявляет фичи с баллами в self-assessment → [студенты-эксперты](./DEFENCE_PEER.md) валидируют ("работает ли") → [ментор](./DEFENCE_MENTOR.md) оценивает качество кода и понимание.
...
Студенты-эксперты оценивают по 4 критериям на [сессии Peer Review](./DEFENCE_PEER.md):
