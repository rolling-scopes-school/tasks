...
> **Кросс-функциональные фичи** (Theme Switcher, i18n, Accessibility, Advanced Animations и т.п.). Баллы получает каждый участник, который может показать работающую интеграцию в своих компонентах и объяснить код.
