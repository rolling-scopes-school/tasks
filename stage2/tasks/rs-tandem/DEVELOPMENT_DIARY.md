...
7. **Не используйте Squash для коммитов дневника.** При сквоше оригинальные даты коммитов затираются, а нам нужна реальная история Git для проверки регулярности.
