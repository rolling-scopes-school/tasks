...
3.  **Комментарии:** Вы обязаны объяснять вслух тот код который вы пишите: почему выбран этот тип данных, зачем этот `if`, как обрабатывается ошибка и т.д.
...
| **100** | Рефлексивный | Глубокая рефлексия, сравнение вариантов импелементации, видно что написано не для галочки |
