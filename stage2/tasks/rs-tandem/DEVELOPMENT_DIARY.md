...
* **0 баллов:** Дневника нет или он фиктивный (залит в последний день).
* **10 баллов:** Формальные, очень краткие записи без деталей.
* **20-30 баллов:** Регулярный лог действий. Есть минимум 2 записи в неделю. Виден прогресс.
* **40 баллов:** Есть описание проблем и решений. Понятно, почему приняты те или иные решения.
* **50 баллов:** Глубокая рефлексия, хотя бы в части записей. Есть записи в формате Post-Mortem (анализ ошибок) и Spike (объяснение, почему выбрано то или иное решение, сравнение вариантов).