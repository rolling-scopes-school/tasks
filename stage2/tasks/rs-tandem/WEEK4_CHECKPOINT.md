...
Без `TESTING.md` парсер сам найдёт тест-файлы и определит авторство по `git blame`.
...
| Можно ли использовать AI для написания тестов? | AI может помочь с синтаксисом, но тесты должны быть осмысленными и покрывать ваш код. |
