...
1. написать минимум 5 unit-тестов для кода, который вы лично разработали.
...
| Можно ли зачесть ранее написанные тесты?       | Да, если написаны лично вами и отражены в дневнике за Week 4.                                                                                            |
| Нужен ли отдельный сабмит?                     | Нет. Парсер проверяет автоматически: тестовый фреймворк в `package.json`, тестовые файлы, ссылки в дневнике.                                             |
