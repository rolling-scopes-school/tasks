...
_Вопрос:_ Можно использовать Jest вместо Vitest?
_Ответ:_ Да. Любой тестовый фреймворк для JS/TS.

_Вопрос:_ Нужны ли E2E тесты?
_Ответ:_ Нет. Достаточно unit-тестов. E2E — опционально для Personal Features.

_Вопрос:_ 5 тестов — это мало, зачем?
_Ответ:_ Цель — начать. 5 тестов = привычка сформирована. Дальше дописать легче, чем начать с нуля.

_Вопрос:_ Можно ли ревьюить PR вне своей команды?
_Ответ:_ Нет. Только PR в вашем командном репозитории.

_Вопрос:_ Что если в команде нет открытых PR?
_Ответ:_ Используйте Вариант Б — опишите в дневнике, как разбирались в коде тиммейта. Или создайте PR со своими тестами и попросите тиммейта сделать то же.

_Вопрос:_ Можно ли использовать AI для написания тестов?
_Ответ:_ AI может помочь разобраться с синтаксисом, но тесты должны быть осмысленными и покрывать ваш код. Копипаста из ChatGPT без понимания — не засчитывается.

_Вопрос:_ Что если не сделаю чекпоинт?
_Ответ:_ 0 баллов. Других последствий нет, на допуск к защите не влияет.

_Вопрос:_ Можно ли зачесть ранее написанные тесты?
_Ответ:_ Да, если написаны лично вами и отражены в дневнике за Week 4.

_Вопрос:_ Нужен ли отдельный сабмит?
_Ответ:_ Нет. Парсер проверяет автоматически: тестовый фреймворк в `package.json`, тестовые файлы, ссылки в дневнике.
