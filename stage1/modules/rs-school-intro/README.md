...
2. Read the course documentation <https://rs.school/ru/docs>
   - Learning process
...
3. Include your GitHub account in your Discord nickname <https://rs.school/ru/docs/rs-school-chats>
4. Bookmark the course schedule. To do this, go to https://app.rs.school/ and navigate to the "Schedule" page.
5. Take the "[St1] RSS Test" in RS APP ([Submitting assignments in RS APP](https://rs.school/ru/docs/rs-app-tasks#тесты)).
