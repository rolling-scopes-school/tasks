...
4. Each commit must be made according to the [commit requirements](https://rs.school/ru/docs/git-convention#требования-к-именам-коммитов) and comply consistently with one of the [commit message style](#commit-message-style) options.
...
8. A Pull Request must be described according to [the following rules](https://rs.school/ru/docs/pull-request-review-process#требования-к-pull-request-pr).
