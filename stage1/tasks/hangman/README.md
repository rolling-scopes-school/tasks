...
- Commit messages must follow the [guideline](https://rs.school/ru/docs/git-convention)
...
- The pull request description must be provided according to the [template](https://rs.school/ru/docs/pull-request-review-process#требования-к-pull-request-pr).
