...
- [Cross-check review](https://rs.school/ru/docs/cross-check-flow) of the ["codejam #1"](../tasks/) project
...
- [Cross-check review](https://rs.school/ru/docs/cross-check-flow) of project ["shelter. week-1"](stream1/shelter#порядок-оценки-cross-check-неделя-1)
...
- [Cross-check review](https://rs.school/ru/docs/cross-check-flow) of project ["shelter. week-2"](stream1/shelter#порядок-оценки-cross-check-неделя-2)
...
- [Cross-check review](https://rs.school/ru/docs/cross-check-flow) of the project ["online-zoo. week-3"](stream1/shelter#порядок-оценки-cross-check-неделя-3) @sergeyshalyapin
...
- [Cross-check review](https://rs.school/ru/docs/cross-check-flow) of the project ["codejam #2"](../tasks/)
...
- [Cross-check review](https://rs.school/ru/docs/cross-check-flow) of the project ["codejam #3"](../tasks/)
...
- [Cross-check review](https://rs.school/ru/docs/cross-check-flow) of project ["HTML-Builder"](modules/html-builder/)
