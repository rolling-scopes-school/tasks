...
Если *бургер-меню* реализовано только на одной странице или не реализовано совсем - ставится **0**
...
- При нажатии на *бургер-меню*, с правой стороны выезжает блок шириной 320px, в котором вертикально расположены и центрированы элементы меню. Выезд сверху, а не справа, ошибкой не считается, но в таком случае заезжать меню тоже должно вверх, а не вправо.
...
За каждое нарушение требований снимается **-3** балла, но не более -20.
