...
- Логотип находится слева. Логотип состоит из текстовых элементов. Нажатие на логотип оставляет нас на текущей странице.
...
- Нажатие на `Contacts` перебрасывает нас на блок *Footer*, расположенный на этой же странице (якорная ссылка).
- Логотип находится слева. Логотип состоит из текстовых элементов. Нажатие на логотип перебрасывает нас на страницу *main*.
- На странице обязательно должен присутствовать один элемент `<h1>`. Можно сделать его с текстом `Cozy House`.
...
- Наведение на карточку может только менять курсор, а может и делать подсветку кнопки `Learn more`, или даже менять фон. При этом будут сниматься баллы, если: 
...
- Нет карточек с питомцами: **-10**. Карточки есть, но при этом:
  ...
  - Количество карточек не соотвествует макету: **-2**.
  - Струтура карточек нарушена (например текст или кнопка сверху над картинкой): **-2**.
- Наведение на карточку должно сопровождаться hover-эффектом как самой карточки, так и кнопки `Learn more` этой карточки. При этом будут сниматься баллы, если: 
  - Карточки не интерактивные: **-2**.
  - Кнопка `Learn more` не получает hover-эффект при наведении на любое место карточки: **-2**.
