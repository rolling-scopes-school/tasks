...
Создана страница *Landing*: **+60**. Иначе, если страница не существует, ставим **0**, и переходим к следующей странице.
...
Создана страница *donate*: **+40**. Иначе, если страница не существует, ставим **0**.
...
2. (max-width: 1000px) - Изменение расположения кнопок врпаво/влево в блоке `Pets`. Изменение количества отзывов в блоке `Testimonials`. 
...
- Расположение или отступы между карточками животных в блоке `Pets`: **-5**.
...
- Количество, расположение или отступы между отзывами в блоке `Testimonials`: **-5**.
...
### Открываем страницу Donate, и изменяем размеры окна. Если при этом страница ведет себя адаптивно, т.е. меняет дизайн и расположение элементов, ставим **+60**. Иначе, если страница статична, и сохраняет размер 1600px, ставим **0**, и переходим к проеврке следующей страницы.
...
3. **Автоматическая карусель** в блоке Testimonials для дизайна 640px и меньше.

4. **Попап** при нажатии на отзыв в блоке Testimonials.
...
1. **Меню** в хедере, как только панель навигации превращается в бургер-меню. **+10**.
...
2. **Автоматическая карусель** перелистывает блоки с отзывами автоматически в блоке Testimonials **+20**. Баллы снимаем, если:
...
3. **Автоматическая карусель** перелистывает блоки с отзывами автоматически в блоке Testimonials **+20**. для дизайна 640px и меньше.

4. **Попап** при нажатии на отзыв в блоке Testimonials. **+10**.


#### Donate

1. **Панель Amount** в блоке Pick and feed a friend сделана и реагирует на нажатия кружков в панели сумм **+20**. Баллы снимаем, если:
