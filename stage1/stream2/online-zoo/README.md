...
- При открытии появляется меню, как в [макете](https://www.figma.com/file/ypzT9idgAILaSRVRmDAJxn/). Однако, в макете не хватает "крестика" (кнопки закрытия) в правом верхнем углу, поэтому ее нужно добвать на свой вкус. Можно взять из дизайна попапа отзыва.  
