...
- - Затемняется картинка (накладывается полупрозрачный фон, или сама картинка становится полупрозрачной) и высплавает скрытая надпись (светлая или темная значения не имеет, главное чтобы на фоне картинки читалась).
