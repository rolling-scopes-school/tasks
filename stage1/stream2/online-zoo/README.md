...
2. Открываем на ширине экрана 1000px или более так, чтобы были видны 3 отзыва, вместо 4х. Проверяем условия из пункта 1, и снимаем баллы только за **новые**, появившиеся на этой ширине окна, ошибки.  
